...
class uipress_module_google_analytics
{
	...
	public function start()
	{
		...
		//AJAX
		add_action('wp_ajax_uipress_analytics_get_page_views', array($this,'uipress_analytics_get_page_views'));
		add_action('wp_ajax_uipress_analytics_get_bounce_rate', array($this,'uipress_analytics_get_bounce_rate'));
		add_action('wp_ajax_uipress_analytics_get_session_duration', array($this,'uipress_analytics_get_session_duration'));
		add_action('wp_ajax_uipress_analytics_get_page_speed', array($this,'uipress_analytics_get_page_speed'));
		add_action('wp_ajax_uipress_analytics_get_site_users', array($this,'uipress_analytics_get_site_users'));
		add_action('wp_ajax_uipress_analytics_get_site_devices', array($this,'uipress_analytics_get_site_devices'));
		add_action('wp_ajax_uipress_analytics_get_country_visits', array($this,'uipress_analytics_get_country_visits'));
		add_action('wp_ajax_uipress_analytics_get_sources', array($this,'uipress_analytics_get_sources'));
		add_action('wp_ajax_uipress_analytics_get_page_traffic', array($this,'uipress_analytics_get_page_traffic'));

		add_action('wp_ajax_uipress_get_google_images', array($this,'uipress_get_google_images'));
		add_action('wp_ajax_uipress_save_analytics_account', array($this,'uipress_save_analytics_account'));		
		add_action('wp_ajax_uipress_remove_google_account', array($this,'uipress_remove_google_account'));
	...
	public function uipress_analytics_get_site_devices(){
		...
		if (defined('DOING_AJAX') && DOING_AJAX && check_ajax_referer('uipress-overview-security-nonce', 'security') > 0) {
			...
			$bordercolors = array('rgba(12, 92, 239, 1)', 'rgba(50, 210, 150, 1)','rgba(250, 160, 90, 1)');
			$backgroundcolors = array('rgba(12, 92, 239, 0.5)', 'rgba(50, 210, 150, 0.5)','rgba(250, 160, 90, 0.5)');
			$output = array();
	...
	public function register_analytics_cards($cards){
		...
		$temp['premium'] = false;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/page-views.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true; 
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/page-speed.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/site-users.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/site-devices.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/bounce-rate.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/session-duration.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/country-visits.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/traffic-sources.min.js';
		$cards[] = $temp;
		...
		$temp['category'] = __('Analytics','admin2020');
		$temp['premium'] = true;
		$temp['componentPath'] = $this->path . 'assets/js/admin2020/overview-modules/analytics/page-traffic.min.js';
		$cards[] = $temp;
